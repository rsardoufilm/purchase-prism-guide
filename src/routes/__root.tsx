...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "AURA Consumo — Entenda para onde seu dinheiro está indo" },
      {
        name: "description",
        content:
          "AURA Consumo é a inteligência de consumo baseada em OCR de notas fiscais. Entenda seus gastos, hábitos de compra e oportunidades de economia.",
      },
      { property: "og:title", content: "AURA Consumo — Entenda para onde seu dinheiro está indo" },
      {
...
function RootShell({ children }: { children: ReactNode }) {
  const noFlash = `try{var t=localStorage.getItem('aura.theme');var d=t?t==='dark':matchMedia('(prefers-color-scheme: dark)').matches;if(d)document.documentElement.classList.add('dark');}catch(e){}`;
  return (
    <html lang="pt-BR">
      <head>
        <HeadContent />
