  ...
  return (
    <div className="min-h-screen bg-background text-foreground pb-28 md:pb-0 md:pl-20">
      ...
      <nav className="md:hidden fixed bottom-0 left-0 w-full bg-card/85 backdrop-blur-xl border-t border-border z-50">
        <div className="grid grid-cols-5 items-end px-2 pt-2 pb-6">
          ...
          >
            <div className="size-14 rounded-2xl bg-primary text-primary-foreground grid place-items-center shadow-[var(--shadow-elevated)] ring-4 ring-background">
