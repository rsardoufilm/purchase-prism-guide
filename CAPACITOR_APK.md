...
O projeto usa **TanStack Start (SSR)**, então o APK é um *wrapper* nativo que carrega o app publicado em `https://purchase-prism-guide.lovable.app` via webview do Capacitor.
